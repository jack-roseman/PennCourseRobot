...
module.exports.onboardUser = async function (pennkey, password) {
    ...
    // Goto PennInTouch login screen
    await page.goto('https://pennintouch.apps.upenn.edu/pennInTouch/jsp/fast.do');
    await page.setViewport({
        width: 1280,
        height: 689
    });
    ...
    await page.waitForNavigation(); //wait for 2 factor autentication
    await page.waitForNavigation(); //wait for user to accept DUO authentication (30 seconds max)
